...
ADMIN_EXPIRE_AFTER = getattr(settings, 'SESSION_SECURITY_ADMIN_EXPIRE_AFTER', EXPIRE_AFTER)

WARN_AFTER = getattr(settings, 'SESSION_SECURITY_WARN_AFTER', 540)

ADMIN_WARN_AFTER = getattr(settings, 'SESSION_SECURITY_ADMIN_EXPIRE_AFTER', WARN_AFTER)
